...
function timer(){
    ...
    if (tiempo==0){
        clearInterval(caja)
        document.getElementById("jajajajajaj").style.display="flex"
        }
}
function draw(){
    if(mouseIsPressed){
        stroke(document.getElementById("color").value)
        strokeWeight(document.getElementById("grosor").value)
        line(pmouseX,pmouseY,mouseX,mouseY)
    }
}
function eraseUnaVez(){
    background("lightgray")
}
function jojojojo(){
    iaai.classify(canvas,ERURQTLNRCLGYDUBS_TSCSRSPYNBANPDL_PNLSCBYAREPSSN_TDTFRSYDAMTBSA)
}
function ERURQTLNRCLGYDUBS_TSCSRSPYNBANPDL_PNLSCBYAREPSSN_TDTFRSYDAMTBSA(erroor,response){
    if(!erroor){
        ...
        =response[0].label
        document.getElementById("ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo0").innerHTML="🔎"+oooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
        if (butIAmTheChosenOne==oooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo){
            clearInterval(caja)
            veintiunoSeisDoce=veintiunoSeisDoce+posibili
            document.getElementById("showPts").innerHTML=veintiunoSeisDoce
...
function raguj(){
    ...
    document.getElementById("jajajajajaj").style.display="none"
    butIAmTheChosenOne=random(dibujos)
    document.getElementById("holaqwertyhuiopasdfghjklñzxcvbnm").innerHTML=butIAmTheChosenOne
    switch(document.getElementById("dificult").value){
        case "facil":tiempo=40; posibili=5;break;
        case "medio":tiempo=30; posibili=20;break;
        case "dificil":tiempo=15; posibili=35;break;
        case "brutal":tiempo=5; posibili=50;break;
    }
    caja=setInterval(timer, 1000)
}